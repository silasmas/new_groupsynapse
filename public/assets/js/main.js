  ...
  function updateCartUI() {
    $.ajax({
      ...
      success: function(cart) {
        ...
        $(".cart-total-price").text(cart.sub_total + " €");
                    ...
                    <li class="d-flex align-items-start">
                        <div class="cart-img">
                            <a href="/produit/${item.product.slug}">
                                <img src="${item
                                  .product.imageUrls[0]}" width="100" height="100" alt="">
                            </a>
                        </div>
                        <div class="cart-content">
                            <h4>
                                <a href="/produit/${item
                                  .product.slug}">${item.product.name}</a>
                            </h4>
                            <div class="cart-price">
                                <span class="new">${item
                                  .product.soldePrice} €</span>
                                <span><del>${item.product.prix} €</del></span>
                            </div>
                        </div>
                        <div class="del-icon">
                            <a href="#" class="remove-from-cart" data-id="${item
                              .product.id}">
        ...
        $minicart.append(`
                <li>
                    <div class="total-price">
                        ...
                        <span class="f-right">${cart.sub_total} €</span>
                    </div>
                </li>
                <li>
...
=============================================*/
  $("[data-countdown]").each(function() {
    ...
    $this.countdown(finalDate, function(event) {
      $this.html(
        event.strftime(
          '<div class="time-count day"><span>%D</span>Day</div><div class="time-count hour"><span>%H</span>Hr</div><div class="time-count min"><span>%M</span>Min</div><div class="time-count sec"><span>%S</span>Sec</div>'
        )
      );
    });
  });
